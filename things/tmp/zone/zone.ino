...
#define APPID   "AOI"
#define KEY     "h3rFuyOrazmEk5A"
#define SECRET  "06gUhQUG1jLBD2z3aF2NOwVt7"
#define ALIAS   "zone1"


WiFiClient client;
CMMC_Interval timer001,timer002;
...
void loop() {
  ...
  if (microgear.connected()) {
    ...
    timer002.every_ms(15000, []() {
      Serial.printf("Thingspeak [%lu]\r\n", millis());
      ThingSpeak.setField(1,"999");
